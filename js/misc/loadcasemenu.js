...
function loadcasemenu_init(){
    ...
    render_scene.model.model_data.addEventListener('newloadcase', function (loadcase_name){
        loadcase_select.add(new Option(loadcase_name))
    });

    // listener when the model data removes a load case -> update the ui
    render_scene.model.model_data.addEventListener('removedloadcase', function (loadcase_name){
    ...
    render_scene.model.model_data.addEventListener('clearedloadcases', function (){
    ...
    render_scene.model.model_data.addEventListener('activeloadcasechanged', function (loadcase_name){
...
loadcase_remove.onclick = function (){
    ...
    render_scene.model.model_data.removeLoadCase();
}
loadcase_select.onchange = function (){
    ...
    // loadcase.
    render_scene.model.model_data.setActiveLoadCase(loadcase_select.value);
}
